...
GC_33 = Coupling(name = 'GC_33',
                 value = '-((ee*complex(0,1)*the)/(sw*cmath.sqrt(2)))',
                 order = {'QED':1})

GC_34 = Coupling(name = 'GC_34',
                 value = '-(ee*complex(0,1)*the)/(2.*cw*sw)',
                 order = {'QED':1})

GC_35 = Coupling(name = 'GC_35',
                 value = '-((ee*complex(0,1)*thm)/(sw*cmath.sqrt(2)))',
                 order = {'QED':1})

GC_36 = Coupling(name = 'GC_36',
                 value = '-(ee*complex(0,1)*thm)/(2.*cw*sw)',
                 order = {'QED':1})

GC_37 = Coupling(name = 'GC_37',
                 value = '-((ee*complex(0,1)*tht)/(sw*cmath.sqrt(2)))',
                 order = {'QED':1})

GC_38 = Coupling(name = 'GC_38',
                 value = '-(ee*complex(0,1)*tht)/(2.*cw*sw)',
                 order = {'QED':1})

GC_39 = Coupling(name = 'GC_39',
                 value = '-((complex(0,1)*MNR*the)/vev)',
                 order = {'QED':1})

GC_40 = Coupling(name = 'GC_40',
                 value = '-((complex(0,1)*MNR*thm)/vev)',
                 order = {'QED':1})

GC_41 = Coupling(name = 'GC_41',
                 value = '-((complex(0,1)*MNR*tht)/vev)',
                 order = {'QED':1})
