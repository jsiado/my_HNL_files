...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WNR)
      ...
      CALL FFS5_1(W(1,6),W(1,7),GC_40,MDL_MNR, FK_MDL_WNR,W(1,8))
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV6_1(W(1,6),W(1,8),GC_36,MDL_MNR, FK_MDL_WNR,W(1,2))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,3),W(1,2),W(1,7),GC_35,AMP(2))
      CALL FFV6_3(W(1,5),W(1,6),GC_13,MDL_MW, FK_MDL_WW,W(1,2))
      CALL FFV6_1(W(1,4),W(1,2),GC_35,MDL_MNR, FK_MDL_WNR,W(1,6))
C     Amplitude(s) for diagram number 3
      CALL FFV6_0(W(1,3),W(1,6),W(1,7),GC_35,AMP(3))
